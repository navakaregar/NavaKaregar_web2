...
class HotelController extends AbstractController
{
    ...
    public function search(Request $request, SearchService $hotelSearchService, HotelRepository $hotelRepository): Response
    {
        return $this->render('hotel/index.html.twig', [
            'hotels' => $hotelSearchService->search($request->query->get('q'))
        ]);
    }
